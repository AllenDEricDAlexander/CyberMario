...
public interface ImMessageRepository extends JpaRepository<ImMessagePo, Long> {
    ...
    Optional<ImMessagePo> findByConversationIdAndMessageSeqAndDeletedFalse(Long conversationId, Long messageSeq);
    ...
    Page<ImMessagePo> findByConversationIdAndMessageSeqLessThanEqualAndDeletedFalseOrderByMessageSeqAsc(
            Long conversationId, Long messageSeq, Pageable pageable);

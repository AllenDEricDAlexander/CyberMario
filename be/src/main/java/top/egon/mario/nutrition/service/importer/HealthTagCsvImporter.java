...
/**
 * CSV importer for general health restriction tags.
 */
@Component
public class HealthTagCsvImporter extends AbstractHealthTagCsvImporter {

    public HealthTagCsvImporter(NutritionImportJobRepository importJobRepository,
    ...
    protected NutritionImportType supportedImportType() {
        return NutritionImportType.HEALTH_TAG;
    }

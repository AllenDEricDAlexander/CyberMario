...
public class AgentMcpRbacResourceProvider implements RbacResourceProvider {
    ...
    public List<RbacResourceSeed> resources() {
        return List.of(
                ...
                menu(AgentMcpPermissionCatalog.MENU_TOOLS, "MCP 工具策略", "/agent/mcp/tools",
                        "agent-mcp-tools", 12, "ToolOutlined"),
                ...
                button(AgentMcpPermissionCatalog.BTN_TOOL_EDIT_POLICY, "编辑 MCP 工具策略",
                        AgentMcpPermissionCatalog.MENU_TOOLS, "editPolicy", 1, TOOL_API_CODES),
                button(AgentMcpPermissionCatalog.BTN_TOOL_TOGGLE, "启停 MCP 工具", AgentMcpPermissionCatalog.MENU_TOOLS,
                        "toggle", 2, TOOL_API_CODES),
